        ...
        if( empty( $value ) ) {
            if( get_option( "_{$name}" ) ) {
                ...
                if( class_exists('ReviewXPro') ) {   
                    ...
                    if( $name == 'rx_option_display_location' && self::rx_exists_option( '_rx_option_display_location' ) == false ) {
                        $value = 1;
                    } else if( $name == 'rx_option_display_location' && self::rx_exists_option_blank_value( '_rx_option_display_location' ) == '' ) { 
                        $value = get_option( "_{$name}" );
                    } 
                    ...
                    if( $name == 'rx_option_allow_reviewer_name_censor' && self::rx_exists_option( '_rx_option_allow_reviewer_name_censor' ) == false ) {
                        $value = $default;
                    } else if( $name == 'rx_option_allow_reviewer_name_censor' && self::rx_exists_option_blank_value( '_rx_option_allow_reviewer_name_censor' ) == '' ) {                    
                         $value = get_option( "_{$name}" );
                    }             
    ...
    public static function render_meta_field( $key = '', $field = [], $value = '', $idd = null, $is_pro = false )
    {
        ...
        if( empty( $value ) ) {
            ...
            if( class_exists('ReviewXPro') ) {
                ...
                if( $name == 'rx_meta_' && metadata_exists( 'post', $post_id, "_rx_meta_allow_multiple_review" ) == false ) {
                    $value = 1;
                } else if( $name == 'rx_meta_allow_multiple_review' && get_post_meta( $post_id, "_{$name}", true ) == '' ) { 
                    $value = get_post_meta( $post_id, "_{$name}", true );
                } 
                if( $name == 'rx_meta_allow_reviewer_name_censor' && metadata_exists( 'post', $post_id, "_rx_meta_allow_reviewer_name_censor" ) == false ) {
                    $value = 1;
                } else if( $name == 'rx_meta_allow_reviewer_name_censor' && get_post_meta( $post_id, "_{$name}", true ) == '' ) { 
                    $value = get_post_meta( $post_id, "_{$name}", true );
                }                     
