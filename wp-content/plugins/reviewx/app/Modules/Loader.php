    ...
    public function setSubmenu()
    {
        ...
        if( $wc_is_enabled && class_exists('WooCommerce') ) {
            $this->submenu = apply_filters('rx_admin_submenu', [
                ...
                'google_reviews' => [
                    'parent_slug'   => 'rx-admin',
                    'page_title'    => __('Google Review', 'reviewx'),
                    'menu_title'    => __('Google Review', 'reviewx'),
                    'capability'    => 'manage_options',
                    'menu_slug'     => 'reviewx-google-review',
                    'callback'      =>  array((new ReviewxAdmin(REVIEWX_PLUGIN_NAME, "1.0.2")), 'google_reviews')
                ],  
                // 'reviewx_discount' => [
                //     'parent_slug'   => 'rx-admin',
