		...
		public function new_notice()
		{
			...
			if ($second_notice == false) {
				if (!\ReviewX_Helper::is_pro()) {
					...
					$output .= '<p class="second-notice-bar-text" style="padding: 12px 0px 10px 0px;">Get exclusive <strong> 25% </strong> OFF with coupon code <strong><i> ‘RVXSPECIAL25’  </i> </strong> while upgrading to <strong > ReviewX PRO</strong></p>';
