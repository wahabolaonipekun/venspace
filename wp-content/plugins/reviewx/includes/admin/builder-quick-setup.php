                ...
                'sections'      => apply_filters('rx_content_tab_sections', array(
                    ...
                    'allow_utilities' => array(
                        ...
                        'fields' => array(                              
                            ...
                            'allow_location' => array(
                                'is_pro' => true,
                                'heading' => __('Display Reviewer\'s Country with Review', 'reviewx'),
                                'label' => __('Display reviewer country along with their review', 'reviewx'),
                                'type'  => 'switcher',
                                'disabled' => true
                            ),                            
                            ...
                            'allow_reviewer_name_censor' => array(
                                'is_pro' => true,
                                'heading' => __('Reviewer Name Censor', 'reviewx'),
                                'label' => __('Hide Reviewer Name', 'reviewx'),
                                'type'  => 'switcher',
                                'default'   => 0
                            ),    
