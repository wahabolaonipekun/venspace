...
if ( defined( 'WP_CLI' ) ) {
	...
	require_once AI1WMGE_VENDOR_PATH .
				...
				'command' .
				DIRECTORY_SEPARATOR .
				'class-ai1wmge-gdrive-wp-cli-incremental-command.php';
}
...
require_once AI1WMGE_EXPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-export-incremental-backups.php';

require_once AI1WMGE_EXPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-export-incremental-content.php';

require_once AI1WMGE_EXPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-export-incremental-media.php';

require_once AI1WMGE_EXPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-export-incremental-plugins.php';

require_once AI1WMGE_EXPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-export-incremental-themes.php';
...
require_once AI1WMGE_IMPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-import-incremental-download.php';

require_once AI1WMGE_IMPORT_PATH .
			DIRECTORY_SEPARATOR .
			'class-ai1wmge-import-incremental-gdrive.php';
