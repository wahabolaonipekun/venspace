...
<div class="ovabrw-single-product">
	...
	<div class="product-container vs-d-block">
		<div class="product-container-left vs-no-border">
		    ...
		    <?php endif; ?>
			<div class="vs-flex vs-a-item-center">
...
<!-- 				<div class="product-short-description">
			...
			<?php endif; ?>
			<div class="vs-flex vs-a-item-end vs-pd-top-50">
				
				<?php $respond = get_post_meta($post->ID, 'responds_time', true);
				$currency_symbol = get_woocommerce_currency_symbol( $currency );
				
			if ( ( $tour_day || $tour_hour ) && $product->is_type( 'ovabrw_car_rental' ) ) :?>
			...
			<?php endif;?>
				...
				<div class="">
					Responds within <?php esc_html($respond); ?> hr
				</div>
				<?php endif; ?>
				<div class="vs-mg-auto">
					...
					<?php if ( isset( $sale_price ) && $regular_price ): ?>
						...
						<div class="">
							...
							?>
							<span class="old-product-price"><?php echo  $currency_symbol.$result;?> total</span>
							<?php if ( ( $tour_day || $tour_hour ) && $product->is_type( 'ovabrw_car_rental' ) ) :?>
					...
					<?php elseif ( ! isset( $sale_price ) && $regular_price ): ?>
						...
						<?php endif; ?>
						<div class="">
							<span class="old-product-price"><?php echo $currency_symbol .$formatted_price; ?> total</span>
							<?php if ( ( $tour_day || $tour_hour ) && $product->is_type( 'ovabrw_car_rental' ) ) :?>
								<span>/ <?php echo $period; ?></span>
							<?php endif; ?>
						</div>
				    <?php else: ?>
				    	<?php if ( ! $product || ! $product->is_type('ovabrw_car_rental') ): ?>
							...
							<?php endif; ?>
							<div class="">
								<span class="old-product-price"><?php //echo ($product->get_price_html() x 12); ?> total</span>
								<?php if ( ( $tour_day || $tour_hour ) && $product->is_type( 'ovabrw_car_rental' ) ) :?>
									<span>/ <?php echo $period; ?></span>
								<?php endif; ?>
							</div>
